...
public enum FilmLeaderboardEnum implements BaseEnum {
    ...
    LEADERBOARD_VARIETY_NOTICE("VARIETY_NOTICE", "综艺总榜",5),
    LEADERBOARD_CARTOON_NOTICE("CARTOON_NOTICE", "动漫总榜",7),
    LEADERBOARD_USDRAMA_NOTICE("USDRAMA_NOTICE", "美剧总榜",6),
    LEADERBOARD_HIT_NOTICE("HIT_NOTICE", "热播榜",1),
    LEADERBOARD_SCORE_NOTICE("SCORE_NOTICE", "高分榜",2),
    LEADERBOARD_EPISODE_NOTICE("EPISODE_NOTICE", "剧集总榜",4);
